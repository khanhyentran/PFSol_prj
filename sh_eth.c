...
static int sh_eth_reset(struct sh_eth_dev *eth)
{
	...
	//sh_eth_write(eth, EDSR_ENALL, EDSR);//RVC removed: EDSR is not available in RZA2M
...
static int sh_eth_tx_desc_init(struct sh_eth_dev *eth)
{
	...
	//sh_eth_write(eth, ADDR_TO_PHY(cur_tx_desc), TDFXR);//RVC removed
	//sh_eth_write(eth, 0x01, TDFFR);/* Last discriptor bit *///RVC removed
#endif
...
static int sh_eth_rx_desc_init(struct sh_eth_dev *eth)
{
	...
	//sh_eth_write(eth, ADDR_TO_PHY(cur_rx_desc), RDFXR);//RVC removed
	//sh_eth_write(eth, RDFFR_RDLF, RDFFR);//RVC removed
#endif
...
static int sh_eth_config(struct sh_eth_dev *eth, bd_t *bd)
{
	...
	//sh_eth_write(eth, 0, PIPR);//RVC removed
#endif
#if defined(SH_ETH_TYPE_GETHER) || defined(SH_ETH_TYPE_RZ)
	//sh_eth_write(eth, APR_AP, APR);//RVC removed
	...
	if (phy->speed == 100) {
...
#if defined(SH_ETH_TYPE_GETHER)
		//sh_eth_write(eth, GECMR_100B, GECMR);//RVC removed
...
#if defined(SH_ETH_TYPE_GETHER)
		//sh_eth_write(eth, GECMR_10B, GECMR);//RVC removed
#elif defined(CONFIG_CPU_SH7757) || defined(CONFIG_CPU_SH7752)
		...
		//sh_eth_write(eth, GECMR_1000B, GECMR);//RVC removed
	}
#endif
