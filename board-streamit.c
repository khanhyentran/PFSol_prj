...
/* ------------ Pin setup section ---------------*/
	...
	/* Audio */
	r7s72100_pfc_pin_assign(P6_8, ALT5, DIIO_PBDC_EN);	/* SSISCK0 */
	r7s72100_pfc_pin_assign(P6_9, ALT5, DIIO_PBDC_EN);	/* SSIWS0 */
	r7s72100_pfc_pin_assign(P6_11, ALT5, DIIO_PBDC_DIS);	/* SSIRxD0 */
	r7s72100_pfc_pin_assign(P6_10, ALT5, SWIO_OUT_PBDCDIS);	/* SSITxD0 */
