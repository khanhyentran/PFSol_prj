...
enum {
	/* E-DMAC registers */
	EDSR = 0, //RVC: NOT available in RZA2M
	EDMR,
	EDTRR,
	EDRRR,
	EESR,
	...
	TDLAR,
	TDFAR,
	TDFXR,//RVC: NOT available in RZA2M
	TDFFR,//RVC: NOT available in RZA2M
	RDLAR,
	RDFAR,
	RDFXR,//RVC: NOT available in RZA2M
	RDFFR,//RVC: NOT available in RZA2M
	TRSCER,
	RMFCR,
	TFTR,
	FDR,
	RMCR,
	EDOCR,//RVC: NOT available in RZA2M
	TFUCR,
	RFOCR,
	IOSR,
	FCFTR,
	...
	PSR,
	RDMLR,
	PIPR,//RVC: NOT available in RZA2M
	RFLR,//RVC: NOT available in RZA2M
	IPGR,
	APR,//RVC: NOT available in RZA2M
	MPR,
	PFTCR,//RVC: NOT available in RZA2M
	PFRCR,//RVC: NOT available in RZA2M
	RFCR,
	RFCF,
	TPAUSER,
	TPAUSECR,
	BCFR,//RVC: NOT available in RZA2M
	BCFRR,
	GECMR,//RVC: NOT available in RZA2M
	BCULR,//RVC: NOT available in RZA2M
	MAHR,
	MALR,
	TROCR,
	CDCR,
	...
	TSFRCR,
	TLFRCR,
	CERCR,//RVC: NOT available in RZA2M
	CEECR,//RVC: NOT available in RZA2M
	RMIIMR, /* R8A7790 */
	MAFCR,
	RTRATE,//RVC: NOT available in RZA2M
	CSMR,//RVC: NOT available in RZA2M
	RMII_MII,//RVC: NOT available in RZA2M
...
// #if defined(SH_ETH_TYPE_RZ2M)   NOTE: SH_ETH_TYPE_RZ2M is not defined until later in this file
static const u16 sh_eth_offset_rz2m[SH_ETH_MAX_REGISTER_OFFSET] = {
	//[EDSR]	= 0x0000,//RVC: NOT available in RZA2M
	[EDMR]	= 0x0000,
	[EDTRR]	= 0x0008,
	[EDRRR]	= 0x0010,
	[EESR]	= 0x0028, //0x0428,
	[EESIPR]	= 0x0030, //0x0430,
	[TDLAR]	= 0x0018,
	[TDFAR]	= 0x00D8,
	//[TDFXR]	= 0x0018,//RVC: NOT available in RZA2M
	//[TDFFR]	= 0x001c,//RVC: NOT available in RZA2M
	[RDLAR]	= 0x0030,
	[RDFAR]	= 0x00CC,
	//[RDFXR]	= 0x0038,//RVC: NOT available in RZA2M
	//[RDFFR]	= 0x003c,//RVC: NOT available in RZA2M
	[TRSCER]	= 0x0038,
	[RMFCR]	= 0x0040,
	[TFTR]	= 0x0048,
	[FDR]	= 0x0050,
	[RMCR]	= 0x0058,
	[TFUCR]	= 0x0064, //RVC: add new, unused in source code
	[RFOCR]	= 0x0068, //RVC: add new, unused
	[IOSR]	= 0x006C,//RVC: add new, unused
	[RPADIR]	= 0x0078,
	[FCFTR]	= 0x0070,
	//[CSMR] = 0x04E4,//RVC: NOT available in RZA2M
	[TRIMD]	= 0x007C, //RVC add new
	[RBWAR]	= 0x00C8, //RVC add new
	[TBRAR]	= 0x00D4, //RVC add new
...
/* Ether registers */
	...
	//[PIPR]	= 0x002c,
	[RFLR]	= 0x0008,
	[RDMLR]	= 0x0040,//RVC add new
	[IPGR]	= 0x0050,//RVC add new
	//[APR]	= 0x0054,
	[MPR]	= 0x0058,
	//[PFTCR]	= 0x005c,
	//[PFRCR]	= 0x0060,
	...
	[RFCF]	= 0x0060,//Add new
	[TPAUSER]	= 0x0064,
	[TPAUSECR]	= 0x0068,//add New
	[BCFRR]	= 0x006E,//Add new
	//[GECMR]	= 0x05b0,
	//[BCULR]	= 0x05b4,
	[MAHR]	= 0x00c0,
	[MALR]	= 0x00c8,
	[TROCR]	= 0x00D0,
	[CDCR]	= 0x00D4,//check again
	[LCCR]	= 0x00D8,
	[CNDCR]	= 0x00DC,//Add new
	[CEFCR]	= 0x00E4,
	[FRECR]	= 0x00E8,
	[TSFRCR]	= 0x00EC,
	[TLFRCR]	= 0x00F0,
...
#define SH_ETH_TYPE_RZ//RVC Consider to Add SH_ETH_TYPE_RZ2M
//#define BASE_IO_ADDR	0xE8204100	/* ch 0 */
#define BASE_IO_ADDR	0xE8204300	/* ETHERC1 - ch 1 */
#define BASE_EDMAC_ADDR	0x000C0200	/* EDMAC1 - ch 1 */ //RVC add
#endif
...
#if 0 //RVC: EDSR is NOT available in RZA2M
...
#if 0 //RVC: NOT available in RZA2M
/* RDFFR*/
enum RDFFR_BIT {
	RDFFR_RDLF = 0x01,
};
					    ...
					    int enum_index)
{
	...
	const u16 *reg_offset = sh_eth_offset_rz2m;
#elif defined(SH_ETH_TYPE_RZ2M)
	const u16 *reg_offset = sh_eth_offset_rz2m;//RVC Consider to add rz2m;
#else
#error
#endif
