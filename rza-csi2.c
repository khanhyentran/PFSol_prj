...
printk("SRST_REG %x",rcar_csi2_read(priv, PHYTIM3_REG));
printk("SRST_REG %x",rcar_csi2_read(priv, PHYTIM2_REG));
printk("SRST_REG %x",rcar_csi2_read(priv, PHYTIM1_REG));
/* Non OS source
...
printk("FLD_REG %x",rcar_csi2_read(priv, FLD_REG));
